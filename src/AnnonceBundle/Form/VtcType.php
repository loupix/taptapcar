...
{   
    ...
    {
        $builder
            ->add("nom_societe", "text", array("required"=>true))
        ...
        ->add('typeTarif', 'choice', array(
            "label" => "Couleur",
            "choices"=>array('Par kilomètres', 'Par heures', 'Par places','Prix unique'),
            'choices_as_values' => true,
            'choice_label' => function ($choice) {
                return $choice;
            },
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'AnnonceBundle\Entity\vtc'
        ));
    }
